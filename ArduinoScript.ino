...
//while(count<5)
  ...
  {
  if(i > UpperThreshold){   
                            // If the signal is above the upper threshold the LED will blink indicating a heartbeat.
  ...
  if(i < LowerThreshold && IgnoreReading==true)// Heart beat trailing edge detected.
  {
    Serial.print(0);
    Serial.print("b");
    IgnoreReading = false;
